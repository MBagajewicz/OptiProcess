...
#   0.2          01-Apr-2025     Mariana Mello             Add Parameters of WC_STHE
...
from WC_STHE.Calculations import Calculations_WC_STHE_flowrates
import sys
...
def Fw_Thi_min(m_p):
    m_p['Fw_Thi_min'] = Calculations_WC_STHE_flowrates.WC_Fw_param(m_p['mh'], m_p['Cph'], m_p['Thi'], m_p['Tho'], m_p['Cpc'],
                                                                   m_p['Tci'], m_p['Thi'])
    #print('Fw_Thi_min',Fw_Thi_min)
    return m_p

def Fw_Tco_min(m_p):
    Tco_deltaTmin = m_p['Tho'] - m_p['DeltaT_min']
    m_p['Tco_min'] = min(m_p['Tco_max'], Tco_deltaTmin)
    m_p['Fw_Tco_min'] = Calculations_WC_STHE_flowrates.WC_Fw_param(m_p['mh'], m_p['Cph'], m_p['Thi'], m_p['Tho'], m_p['Cpc'],
                                                                   m_p['Tci'], m_p['Tco_min'])
    #print('Fw_Tco_min', Fw_Tco_min)
    return m_p
