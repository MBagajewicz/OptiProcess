...
Example1 = {
    ...
    'Equipment1': {
        ...
        'Model_Declarations': {
            ...
            'Discretized_Values_of_Variables': [
                ...
                [0.203, 0.254, 0.305, 0.337, 0.387, 0.438, 0.489, 0.540, 0.591, 0.635, 0.686, 0.737, 0.787, 0.838, 
                 ...
                 [0.345, 0.432, 0.518, 0.573, 0.658, 0.745, 0.831, 0.918, 1.005, 1.079, 1.166, 1.253,
                   1.338, 1.425, 1.512, 1.598, 1.685, 1.814, 1.943, 2.072, 2.201, 2.332, 2.462, 2.591], #DS2(m)
                ...
                [0.05, 0.1, 0.2, 0.4, 0.5], #D_FF(m)

                

                [0.05, 0.1, 0.2, 0.4, 0.5] #D_RF(m)
        ...
        'Model_Parameters': {
            ...
            'Cp_t':2.0505e3,     #Calor especifico no tubo
            'fv': 0.2,           #Fração de vaporização
            'sig': 0.00463,          # tensão superficial
            ...
            'rol_s': 444,       # liquid density (kg/m³)
            'rov_s': 51.5,         # vapor density (kg/m³)
            'mil_s':4e-4,       # liquid viscosity (Pa.s)
            'miv_s': 3e-5,      # vapor viscosity (Pa.s)
            'kl_s': 0.1,       # Thermal conductivity (W/(m.K))
            'Cpl_s': 3245,       #Calor específico do fluido dentro do casco
            ...
            'tr':30,            # tempo de retenção em segundos
            'L_FF': 7.01,          # lenght of the first feed line
            'L_FS': 0.98,          # lenght of the second feed line
            'L_RF': 6.1,          # lenght of the first return line
            'L_RS': 0.98,          # lenght of the second return line
            'Hl_max': 2.7,        # maximum liquid geight inside the colunm
            'Z':0,              # height of the reboiler compared to the base of the colunm
...
Example3 = {
    ...
    'Equipment1': {
        ...
        'Model_Parameters': {
            ...
            'Hvap_s': 233000,   # Vaporization enthalpy (J/kg)
            'Q2':1.59e6,        # Heat load if task = 2
            'rol_s': 461,       # liquid density (kg/m³)
            'rov_s': 31.6,        # vapor density (kg/m³)
            'mil_s':3e-4,       # liquid viscosity (Pa.s)
            'miv_s': 2.5e-5,      # vapor viscosity (Pa.s)
            'kl_s': 0.12,       # Thermal conductivity (W/(m.K))
            'Cpl_s': 2510,       #Calor específico do fluido dentro do casco
...
Example8 = {
    ...
    'Equipment1': {
        ...
        'Model_Parameters': {
            ...
            'multiplier':1,     # multiplication of the original heat load value by three factors: 1, 2 and 4.
            'task':2,           # Shell-side fluid type
            'rol_s': 800,     # Condensate density (kg/m³)
            'rov_s': 5,       # Steam density (kg/m³)
            'tr':30,            # tempo de retenção em segundos
            'L_FF': 7.01,          # lenght of the first feed line
            'L_FS': 0.98,          # lenght of the second feed line
            'L_RF': 6.1,          # lenght of the first return line
