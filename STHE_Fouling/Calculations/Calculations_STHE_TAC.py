...
#   0.3          02-Jul-2025     Augusto Vieira            Included fouling thickness dependency on DPt
...
def STHE_TAC(int_rate, n, par_a, par_b, Nop, pc, eta, Ds, dte, Npt, rp, lay, L, ms, mt, ros, rot, mis, mit, thk, Nb, Bc, m_p,ft_thk):
    ...
    deltaPt = Calculations_STHE_DeltaPtubeside.STHE_tubeside_DeltaP(mt, rot, mit, thk, Ds, dte, Npt, rp, lay, L, m_p,ft_thk)
    #print('DPt', deltaPt)
