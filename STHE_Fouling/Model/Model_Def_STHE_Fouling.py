...
#   0.4         01-Jul-2025     Augusto Vieira             Changed constraints to include fouling dynamics
...
Model_STHE = {
    ...
    'Set_Trimming_Info': {
        ...
        'Set_Trimming_Constraints_List': ['lbmax', 'vs_lb', 'vs_ub','vt_lb','Ret_lb', 'Res_lb',
                                          'Res_ub', 'DPs_ub', 'vt_ub_c','Ret_ub_c', 'DPt_ub_c', 
                                           'Areq_c','F_min','vt_ub_d','Ret_ub_d', 'DPt_ub_d', 'Areq_d'],
        ...
        # clean constraints are set before dirt ones so that exhaustive fouling dynamics calculations are reduced
    ...
    'Enumeration_Info': {
        ...
        'Lower_Bound_Equation': ['LB_TAC'],
        'Fobj_within_LB': 'TAC_OF'
            }
