...
def TAC_OF(Nf_c,Ns_c,m_p):    
    ...
    if results:
        ...
        condenser_duty = results['condenser_duty']
        reboiler_duty = results['reboiler_duty']
        print(f'Condenser Duty = {condenser_duty:.8f} W')
        print(f'Reboiler Duty = {reboiler_duty:.8f} W')
