...
def TAC_OF(Nf_c,Ns_c,m_p):
    ...
    end_aspen = time.time()
    m_p['Aspen_time'] += end_aspen - start_aspen
    ...
    if results:
        ...
        Sieve_Tray_Solution = Solution_within['Equipment3']
        Condenser_Solution = Solution_within['Equipment4']
        Reboiler_Solution = Solution_within['Equipment5']
        Reflux_Drum_Solution = Solution_within['Equipment6']
    ...
    print(f"Aspen time: {m_p['Aspen_time']}")
...
def LB_Gen(Nf_c,Ns_c,m_p):
    ...
    for Nf in range(Nfmin,Nfmax+1):    # For Nf from Nfmin to Nsmax - 2
        ...
        if GD_results[Nf]:
            ...
            GD_results[Nf]['Ns'] = Nsmax
            GD_results[Nf]['Nf'] = Nf

            # Problems Within Solutions:
            GD_Solution_Within[Nf] = Next_Level_Organizer.Next_Level(GD_results[Nf],m_p)
            GD_Sieve_Tray_Solution[Nf] = GD_Solution_Within[Nf]['Equipment3']
            GD_Condenser_Solution[Nf] = GD_Solution_Within[Nf]['Equipment4']
            GD_Reboiler_Solution[Nf] = GD_Solution_Within[Nf]['Equipment5']
            GD_Reflux_Drum_solution[Nf] = GD_Solution_Within[Nf]['Equipment6']
