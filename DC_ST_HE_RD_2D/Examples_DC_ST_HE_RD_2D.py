...
##################################################################################################################
# INSTRUCTIONS
# Add Examples for DC_ST_HE_RD_2D model in this file
##################################################################################################################
# endregion
##################################################################################################################
...
Example2_Pb_10_Ex = copy.deepcopy(Example2_Pb_10)
Example2_Pb_10_Ex['Equipment1']['Model_Declarations']['Type_Enumeration'] = 'Exhaustive'
...
Example1_Pb_10_Fix['Equipment1']['Model_Declarations']['Discrete_Values_of_Variables'] = [[16],[37]]
...
Example2_Pb_10_Fix['Equipment1']['Model_Declarations']['Discrete_Values_of_Variables'] = [[30],[42]]

Example2_Pb_2_Fix = copy.deepcopy(Example2_Pb_2)
Example2_Pb_2_Fix['Equipment1']['Model_Declarations']['Type_Enumeration'] = 'Exhaustive'
Example2_Pb_2_Fix['Equipment1']['Model_Declarations']['Discrete_Values_of_Variables'] = [[9],[24]]
# endregion
###################################################################################################################
###################################################################################################################
...
# Example2_Fix_1['Equipment1']['Model_Declarations']['Discrete_Values_of_Variables'] = [[16],[36]]
# Example2_Fix_1['Next_Level_Equipments']['Equipment1']['Model_Declarations']['Discrete_Values_of_Variables'] = [[1.0668], [0.004], [0.005], [0.0381], [0.4572], [0.6604], [0.009], [0.0034], [1.0]]
# Example2_Fix_1['Next_Level_Equipments']['Equipment2']['Model_Declarations']['Discrete_Values_of_Variables'] = [[0.9144], [0.004], [0.01], [0.0381], [0.4572], [0.6604], [0.009], [0.0034], [1.0]]
# Example2_Fix_1['Next_Level_Equipments']['Equipment3']['Model_Declarations']['Discrete_Values_of_Variables'] = [[1.0668], [0.9144]]
# Example2_Fix_1['Next_Level_Equipments']['Equipment4']['Model_Declarations']['Discrete_Values_of_Variables'] = [[0.43815], [0.038], [4.0], [1.5], [2.0], [1.8293], [4]]
# Example2_Fix_1['Next_Level_Equipments']['Equipment5']['Model_Declarations']['Discrete_Values_of_Variables'] = [[0.203], [0.0508], [2.0], [1.33], [1.0], [1.2195]]
# Example2_Fix_1['Next_Level_Equipments']['Equipment6']['Model_Declarations']['Discrete_Values_of_Variables'] = [[1.0668], [3.6585]]
