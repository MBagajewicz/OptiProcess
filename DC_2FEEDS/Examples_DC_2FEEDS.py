    ...
    'Equipment1': {
        ...
        'Model_Declarations': {
            ...
            'Discrete_Values_of_Variables': [
                            ...
                            list(range(13, 31)), # Nf1 (Feed 1 considered from stage 3 to 40, considering there are always a stripping 
                                                # and a rectifying section)
                                                # Nf is interpreted regarding stages and not trays (same as in Aspen Plus)
                            list(range(13, 31)), # Nf2 (Feed 2 considered from stage 3 to 40, considering there are always a stripping 
                                                # and a rectifying section)
                                                # Nf is interpreted regarding stages and not trays (same as in Aspen Plus)
                            list(range(15, 33))  # Ns (Stages and not trays, as in Aspen Plus)
        ...
        'Model_Parameters': {
            ...
            'Nsmin' : 18,               # Minimum number of stages (Condenser + 11 stages within the column + Reboiler)
