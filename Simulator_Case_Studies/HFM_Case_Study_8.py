...
STREAM_CONFIGS = {
    "Feed": {
        "composition": dict(zip(['CarbonDioxide', 'Nitrogen', 'Methane', 'Ethane', 'n-Propane', 'IsoButane', 'n-Butane', 'Isopentane', 'n-Pentane', 'n-Hexane', 'n-Heptane', 'n-Octane', 'n-Nonane', 'Water', 'HydrogenSulfide'], np.array([0.24117, 0.00322, 0.60129, 0.07544, 0.05384, 0.00693, 0.01361, 0.00162, 0.00212, 0.00057, 0.00013, 4e-05, 1e-05, 1e-06, 5e-06]))),
        "P": 5118000.0,
...
COMMON_PARAMS = {
 ...
 0.000014]),
    ...
    "PPerm": 2.900000e+05,
    "Q": np.array([
            1.376872E-02 * 1000.0 / 3600.0 / 1e5,   # CO2
            8.143925E-04 * 1000.0 / 3600.0 / 1e5,   # N2
            4.957037E-04 * 1000.0 / 3600.0 / 1e5,   # CH4
            9.131018E-05 * 1000.0 / 3600.0 / 1e5,   # C2H6
            1.783062E-05 * 1000.0 / 3600.0 / 1e5,   # C3H8
            1.532688E-05 * 1000.0 / 3600.0 / 1e5,   # C4H10-2
            1.070433E-05 * 1000.0 / 3600.0 / 1e5,   # C4H10-1
            9.264741E-18 * 1000.0 / 3600.0 / 1e5,   # C5H12-2
            5.446816E-15 * 1000.0 / 3600.0 / 1e5,   # C5H12-1
            7.130000E-18 * 1000.0 / 3600.0 / 1e5,   # C6H14-1
            7.422669E-18 * 1000.0 / 3600.0 / 1e5,   # C7H16
            7.130013E-18 * 1000.0 / 3600.0 / 1e5,   # C8H18-1
            5.216610E-13 * 1000.0 / 3600.0 / 1e5,   # C9H20-1
            5.625071E-02 * 1000.0 / 3600.0 / 1e5,   # H2O
            9.727891E-03 * 1000.0 / 3600.0 / 1e5,   # H2S
        ]),
    "DiamShell": 0.33,
    ...
    "MassBalanceLoopIterationTolerance": 1.000000e-05,
    "NumberOfIterationsInLoop": 500,
