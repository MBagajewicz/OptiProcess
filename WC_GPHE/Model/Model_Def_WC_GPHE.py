...
#   0.4         24-Sep-2025     Mariana Mello              Add Incremental Set Trimming
#################################################################################################################
# INPUT: Model of Water Cooler GPHE
##################################################################################################################
##################################################################################################################

# region Model of Water Cooler GPHE
...
Model_WC_GPHE = {
    ...
    'Model_Info': {
        ...
        'Parameters_Calculations_List': ['Fw_Thi_min', 'Fw_Tco_min'],
    ...
    'Set_Trimming_Info': {
        ...
        'Set_Trimming_Constraints_List': ['vh_lb', 'vh_ub', 'Reh_lb', 'Reh_ub', 'DPh_ub', 'vc_lb', 'vc_ub', 'Rec_lb',
                                          'Rec_ub', 'Tco_ub', 'DPc_ub', 'Areq'],
    ...
    'Enumeration_Info': {
        ...
        'Enumeration_Constraint_List': ['Fw_ub_SE', 'vc_ub_SE', 'Rec_ub_SE', 'DPc_ub_SE'],
        ...
        'Lower_Bound_Equation': ['LB_WC_GPHE'],
        # This is the lower bound generation functions required for smart and segmental enumerations
