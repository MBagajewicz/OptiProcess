...
from SPHE_DT.Calculations import Calculations_SPHE_DT_DeltaP, Calculations_SPHE_DT_Area
#endregion
...
def SPHE_TAC(int_rate, n, par_a, par_b, H, L, pc, eta, mh, mc, roh, roc, dh, dc, mih, mic, Nop):
    ...
    dltph, dltpc = Calculations_SPHE_DT_DeltaP.SPHE_DeltaP(L, roh, roc, mh, mc, H, dh, dc, mih, mic)
