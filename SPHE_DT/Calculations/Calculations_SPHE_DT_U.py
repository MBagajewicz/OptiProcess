...
from SPHE_DT.Calculations import Calculations_SPHE_DT_h, Calculations_SPHE_DT_Area
#endregion
...
def SPHE_overall_coefficient(*args):
    ...
    if len(args) == 17:
        ...
        hh, hc = Calculations_SPHE_DT_h.SPHE_h(L, dh, dc, ds, H, thk, mh, mc, mih, mic, Cph, Cpc, kh, kc)
...
def SPHE_overall_coefficient_ub(L, dh, dc, ds, H, thk, mh, mc, mimin, Cpmax, kmax, Rfh, Rfc, kplate):
    ...
    hhub, hcub = Calculations_SPHE_DT_h.SPHE_h_ub(L, dh, dc, ds, H, thk, mh, mc, mimin, Cpmax, kmax)
