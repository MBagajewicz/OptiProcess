...
Model_SPHE_DT = {
    ...
    'Set_Trimming_Info': {
        ...
        'Set_Trimming_Constraints_List': ['vh_lb', 'vh_ub', 'vc_lb', 'vc_ub', 'Reh_lb', 'Rec_lb', 'dltph_ub', 'dltpc_ub', 'Areq_screen', 'Tho_ub_fast_screen'],
        # Cheap constraints and screens. Expensive final constraints should not be evaluated here.

        'Final_Constraints_List': ['Tho_ub'],
        # Expensive final constraints. These are evaluated after sorting candidates by objective function.
        # The first candidate that satisfies these constraints is globally optimal among the trimmed set.
