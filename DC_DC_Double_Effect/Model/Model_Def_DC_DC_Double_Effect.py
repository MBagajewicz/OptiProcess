...
Model_DC_DC_Double_Effect = {
    ...
    'Model_Info': {
        ...
        'Objective_Function': {'Equation_Name': ['OF_BTX_Column'], 'Optimization_Variables_Names': ['OF_Solution'], 'Unit_OF': ['$/year']},
    ...
    'Set_Trimming_Info': {
        ...
        'Set_Trimming_Constraints_List': ['HPCOL_Feasibility'],
