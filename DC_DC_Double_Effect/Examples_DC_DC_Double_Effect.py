...
##################################################################################################################
###################################################################################################################
# region INPUT EXAMPLE 1 - METHANOL-WATER DISTILLATION COLUMN --> Type : DC_DC_Double_Effect + DC_Double_Effect
...
Example1 = {
    ...
    'Equipment1': {
        ...
        'Model_Parameters': {
            ...
            'file_name' : ['Methanol_H2O - LPC - Uniquac.bkp'],
            'block_name' : ['LPC'],
    ...
    'Next_Level_Equipments': {
        ...
        'Equipment1': {
            ...
            'Model_Parameters': {
                ...
                'T_f' :  113.4 + 273.15,            # Feed temperature (K)
                # Separation Task Specification 
                'xB_TOP' : -4422163.71,             # Condenser duty in High Pressure Column (kJ/h)
                #'xB_TOP' : 0.95,                   # Top benzene purity 
                'xB_BOTTOM' : 0.005,                # Bottom benzene purity 
                # Components - NAMES MUST BE THE SAME AS SET IN ASPEN PLUS (if Aspen is to be used)!! CASE SENSITIVE 
                'Comp_name' : ['METHANOL', 'WATER'],      
                ...
                # ---------------------------
                # File, block and streams - ATTENTION: THIS NAMES ARE CASE SENSITIVE, MUST BE THE SAME AS IN ASPEN FILE
                #'file_name' : ['Methanol_H2O - HPC - Uniquac.bkp'],
                'block_name' : ['HPC'],
