...
#   0.2          03-Jun-2025     Miguel Bagajewicz          Extension to Intensified Condenser+Desuperheater+Multic
=======
#   0.0          20-Fev-2025     Alice Peccini             Original
#   0.1          28-Feb-2025     Alice Peccini             Relocating folders
#   0.2          03-Jun-2025     Miguel Bagajewicz         First Set up to add Inntensification/Desuperheating 
...
from Hor_ST_Cond.Calculations import (
    Calculations_Hor_ST_Cond_DeltaP,
    Calculations_Hor_ST_Cond_Geometry,
    Calculations_Hor_ST_Cond_Heat_transfer,
