...
#   0.0         19-Sep-2025     Mariana Mello              Proposed
##################################################################################################################
# INPUT: Setting of examples
##################################################################################################################
# INSTRUCTIONS
# Add WC STHE Model info in this file
##################################################################################################################
...
Model_WC_STHE_Fw = {
    ...
    'Model_Info': {
        ...
        'List_of_Variables': ['Fw', 'Ds', 'dte', 'Npt', 'rp', 'lay', 'L', 'Nb', 'Bc'],
        ...
        'Objective_Function': {
            'Equation_Name': ['TAC_OF','AREA_OF'],
            'Optimization_Variables_Names': ['TAC', 'Area'],
            'Unit_OF': ['$/year', 'm²']
        },
        ...
        'Standard_Variables_Values': {
            'Fw': [44.67, 49.67, 54.67, 59.67, 64.67, 69.67, 74.67, 79.67, 84.67, 89.67, 94.67, 99.67, 104.67, 109.67,
                   114.67, 119.67, 124.67, 129.67, 134.67, 139.67, 144.67, 149.67, 150, 66.93, 70.93, 74.93, 78.93, 82.93, 86.93, 90.93, 94.93, 98.93, 102.93, 106.93, 110.93,
                   114.93, 118.93, 122.93, 126.93, 130.93, 134.93, 138.93, 142.93, 146.93],
    ...
    'Set_Trimming_Info': {
        ...
        'All_Variables_In_The_Problem': ['Fw', 'Ds', 'dte', 'Npt', 'rp', 'lay', 'L', 'Nb', 'Bc'],
        ...
        'Variables_Used_In_Incremental_For_Each_Primordial_Constraint': [['Ds', 'L'], ['Ds', 'L'], ['Ds', 'L', 'Nb'],
                                                                         ['Ds', 'L', 'Nb']],
        ...
        'Set_Trimming_Constraints_List': ['vs_lb', 'vs_ub', 'Res_lb', 'Res_ub', 'F_min', 'DPs_ub', 'vt_lb', 'vt_ub',
                                          'Ret_lb', 'Ret_ub', 'DPt_ub', 'Areq'],
        ...
        'Variables_Used_In_Incremental_For_Each_Set_Trimming_Constraint': [['Ds', 'dte', 'rp', 'lay', 'L', 'Nb'],
                                                                           ...
                                                                           ['Ds', 'dte', 'Npt', 'rp', 'lay', 'L',
                                                                            'Nb', 'Bc'],
                                                                           ['Fw', 'Ds', 'dte', 'Npt', 'rp', 'lay'],
                                                                           ['Fw', 'Ds', 'dte', 'Npt', 'rp', 'lay'],
                                                                           ['Fw', 'Ds', 'dte', 'Npt', 'rp', 'lay'],
                                                                           ['Fw', 'Ds', 'dte', 'Npt', 'rp', 'lay'],
                                                                           ['Fw', 'Ds', 'dte', 'Npt', 'rp', 'lay', 'L'],
                                                                           ['Fw', 'Ds', 'dte', 'Npt', 'rp', 'lay', 'L',
                                                                            'Nb', 'Bc']],
        # This is valid if 'Incremental_Set_Trimming' option is set in True
