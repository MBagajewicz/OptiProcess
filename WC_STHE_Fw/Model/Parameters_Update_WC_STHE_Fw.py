...
#   0.2          19-Sep-2025     Mariana Mello             Proposed
##################################################################################################################
...
from WC_STHE_IST.Model.Model_Def_WC_STHE_IST import Model_WC_STHE_IST
# endregion
##################################################################################################################
...
def consistency(m_d, m_p, save_result):
    ...
    def variables_bounds(m_d):
        m_i = Model_WC_STHE_IST['Model_Info']
        ...
        if 'Tco' in m_p and 'Thi' in m_p and 'Tho' in m_p:
            ...
            if Tco < Thi - deltaTmin:
                if Tco > Tho - deltaTmin:
                    ...
                    m_d['Discrete_Values_of_Variables'][2] = [1] # Npt = 2
                else:
                    pass
            else:
