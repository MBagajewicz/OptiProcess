...
###################################################################################################################
# region INPUT EXAMPLE 1 - HTSR REBOILER
...
Model_HTSR = {
    ...
    'Model_Info': {
        ...
        'List_of_Variables': ['Ds', 'dte', 'Npt', 'rp', 'lay', 'L','D_FF','D_RF'],
    ...
    'Set_Trimming_Info': {
        ...
        'Set_Trimming_Constraints_List': ['vt_lb', 'vt_ub', 'Ret_lb', 'q_ub', 'dPt_up', 'A_exc','VRS_ub','VRF_ub','Hl_ub'],
