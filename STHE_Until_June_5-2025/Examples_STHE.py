...
# region INPUT EXAMPLE 1 - STHE (Kern Method)
...
# region INPUT EXAMPLE 2 - STHE (Kern Method)
...
Example2 = {
    ...
    'Equipment1': {
        ...
        'Model_Parameters': {
            ...
            # Problem
            #'Objective_Function': 'TAC',  # Objective Functions: 'TAC' or 'Area' or 'CAPEX'
            'Aexc': 11,                   # Area excess (%)
...
Example3 = {
    ...
    'Equipment1': {
        ...
        'Model_Parameters': {
            ...
            'roh': 786.4,       # Density (kg*m**-3)
            'Cph': 2177,        # Heat capacity (J*(kg*K)**-1)
            'mih': 0.00189,     # Viscosity (Pa*s)
            'kh': 0.122,        # Thermal conductivity (W*(m*K)**-1)
            'Rfh': 0.0002,      # Fouling factor (m**2*oC*W**-1)
            'DPhdisp': 100e3,   # Available pressure drop (Pa)
