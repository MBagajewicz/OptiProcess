...
from GPHE.Calculations import Calculations_GPHE_area, Calculations_GPHE_DeltaP_channel, Calculations_GPHE_DeltaP_port
#endregion

#region Calculations

def GPHE_TAC(int_rate, n, Ntp, Lp, Lw, par_a, par_b, Dp, Nph, Npc, Sa, Nop, pc, eta, phi, bp, mh, mc, roh, roc, mih, mic):
    ...
    deltaPtotc = (Calculations_GPHE_DeltaP_channel.GPHE_DeltaP_channel(Ntp, Lp, Lw, Dp, Npc, Sa, bp, phi, roc, mic, mc) +
                  Calculations_GPHE_DeltaP_port.GPHE_DeltaP_port(Dp, Npc, mc, roc))*100000
