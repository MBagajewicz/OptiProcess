...
#   0.2          24-Sep-2025     Mariana Mello              Changes to vectorization
##################################################################################################################
#endregion
...
#region Calculations
def GPHE_epsilon_Nutcalc(X, mh, Cph, Thi, Tho, Tci, mc, Cpc):  # Required nut calculation for a given service
    nut_c = X[0]
    pc = X[1]
    pp = X[2]
    ...
    #print("GPHE_epsilon_Nutcalc shape:", f.shape)
    return f
