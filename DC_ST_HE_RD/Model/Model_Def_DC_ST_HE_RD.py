...
##################################################################################################################
# INPUT: Model Definitions for DC_ST_HE_RD model
##################################################################################################################
# INSTRUCTIONS
# Do not modify this file!
##################################################################################################################
######################## DISTILLATION COLUMN + SIEVE TRAY + HEAT EXCHANGERS + REFLUX DRUM ########################
##################################################################################################################
...
Model_DC_ST_HE_RD = {
    ...
    'Next_Level_Info': {
        ...
        'Set_Up_Next_Level': {
            ...
            'Equipment1': 'Set_Up_Sieve_Tray',
            'Equipment2': 'Set_Up_HSTC',
            'Equipment3': 'Set_Up_Kettle',
            'Equipment4': 'Set_Up_Reflux_Drum' 
        }
    }
